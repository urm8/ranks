"""LMArena creative-writing leaderboard — parser owned by this spider."""
...
class LmarenaWritingSpider(SourceSpider):
    name = 'lmarena_writing'
    source_title = 'LMArena creative writing'
    start_urls = ['https://arena.ai/leaderboard/text/creative-writing']
    kind = "benchmark"
    engine = "http"
    arena_category = 'creative-writing'
