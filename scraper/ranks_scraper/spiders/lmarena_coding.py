"""LMArena coding leaderboard — parser owned by this spider."""
...
class LmarenaCodingSpider(SourceSpider):
    name = 'lmarena_coding'
    source_title = 'LMArena coding'
    start_urls = ['https://arena.ai/leaderboard/text/coding']
    kind = "benchmark"
    engine = "http"
