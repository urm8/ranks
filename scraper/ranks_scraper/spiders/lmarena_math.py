"""LMArena math leaderboard — parser owned by this spider."""
...
class LmarenaMathSpider(SourceSpider):
    name = 'lmarena_math'
    source_title = 'LMArena math'
    start_urls = ['https://arena.ai/leaderboard/text/math']
    kind = "benchmark"
    engine = "http"
    arena_category = 'math'
